...
public class InputHandler {
    ...
    public InputHandler(TerminalApp terminalApp, SSHConnector sshConnector, ScreenBuffer screenBuffer, Cursor cursor) {
    ...
    public void attachEventHandlers(InlineCssTextArea terminalArea) {
